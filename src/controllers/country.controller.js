...
export const getAll = async (_, res) =>
  res.json((await supabaseAdmin.from("countries").select("*")).data);

export const getOne = async (req, res) =>
  res.json((await supabaseAdmin.from("countries").select("*").eq("id", req.params.id).single()).data);

export const create = async (req, res) =>
  res.json((await supabaseAdmin.from("countries").insert(req.body).select().single()).data);

export const update = async (req, res) =>
  res.json((await supabaseAdmin.from("countries").update(req.body).eq("id", req.params.id).select().single()).data);

export const remove = async (req, res) => {
  await supabaseAdmin.from("countries").delete().eq("id", req.params.id);
